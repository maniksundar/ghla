...
import com.ghla.library.authority.ReportsFragment.OnListFragmentInteractionListener;
...
public class MyReportsRecyclerViewAdapter extends RecyclerView.Adapter<MyReportsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyReportsRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
